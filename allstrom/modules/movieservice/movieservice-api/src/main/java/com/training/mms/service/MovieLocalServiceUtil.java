 ...
 * <code>com.training.mms.service.impl.MovieLocalServiceImpl</code> and
...
public class MovieLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.training.mms.service.impl.MovieLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Movie createMovie(long movieId) {
	 ...
	 */
	public static Movie deleteMovie(long movieId) throws PortalException {
	...
	public static Movie fetchMovie(long movieId) {
	 ...
	 * @throws PortalException if a movie with the primary key could not be found
	 */
	public static Movie getMovie(long movieId) throws PortalException {
	 ...
	 */
	public static List<Movie> getMovies(int start, int end) {
	...
	private static volatile MovieLocalService _service;
