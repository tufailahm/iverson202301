...
/**
 * The persistence utility for the movie service. This utility wraps <code>com.training.mms.service.persistence.impl.MoviePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MovieUtil {
	 ...
	 */
	public static Map<Serializable, Movie> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Movie> findWithDynamicQuery(
	...
	public static Movie remove(long movieId)
		throws com.training.mms.exception.NoSuchMovieException {
	...
	private static volatile MoviePersistence _persistence;
