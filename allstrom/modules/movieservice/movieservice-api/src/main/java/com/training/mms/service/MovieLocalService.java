...
public interface MovieLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.training.mms.service.impl.MovieLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the movie local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MovieLocalServiceUtil} if injection and service tracking are not available.
	 */
