 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.training.mms.service.impl.MovieLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.training.mms.service.impl.MovieLocalServiceImpl
 * @generated
 */
public abstract class MovieLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MovieLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MovieLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MovieLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return moviePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Movie.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return moviePersistence.findWithDynamicQuery(
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return moviePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	@Override
	public BasePersistence<Movie> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MovieLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		movieLocalService = (MovieLocalService)aopProxy;

		_setLocalServiceUtilService(movieLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MovieLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, movieLocalService);
		}
