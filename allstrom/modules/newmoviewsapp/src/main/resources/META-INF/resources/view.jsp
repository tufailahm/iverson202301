...
<p>
	...
	<h2>Alstrom Private Limited</h2>
		<h2><%= "Loggedd in Date /Time is  :"+ renderRequest.getAttribute("loggedDateTime") %></h2>
...
<%
	...
	PortletURL aboutLiferayURL = renderResponse.createActionURL();
	aboutLiferayURL.setParameter(ActionRequest.ACTION_NAME, "aboutLiferay");
%>
<hr/>
...
<a href="<%= aboutLiferayURL.toString() %>">About Liferay</a> |

<% portletSession.setAttribute("message", "List of movies"); 
portletSession.setAttribute("about", "About Liferay training"); %>
